                ...
                <div class="leftside-navigation">
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a href="{{ route('brandProduct.add') }}">Thêm thương hiệu sản phẩm</a></li>
                                <li><a href="{{ route('brandProduct.all') }}">Liệt kê thương hiệu sản phẩm</a></li>
                            </ul>
                        </li>
        ...
        <section id="main-content">
            ...
            <div class="footer">
                <div class="wthree-copyright">
                    <p>© 2022 Nguyễn Khoa Hoàng. All rights reserved | Design by <a href="http://w3layouts.com">W3layouts</a>
                    </p>
                </div>
            </div>
            <!-- / footer -->
